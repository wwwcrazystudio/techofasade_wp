...
<div class="montage__wrap">
    <div class="container">
        ...
        <div class="montage__video" data-aos="fade-up">
            <iframe width="100" height="100" src="<?=$montage_video;?>" title="YouTube video player" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;" allowfullscreen></iframe>
        </div>
