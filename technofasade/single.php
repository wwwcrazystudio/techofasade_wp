...
<main class="single-news-page">
	<div class="container">
		<?php the_breadcrumbs('single-news-page'); ?>
		</nav>
		<div class="single-news-page__wrap">
			<aside class="single-news-page__sidebar">
				<div class="single-news-page__sidebar-wrap">
					<time datetime="<?= get_the_date('Y-m-d'); ?>" class="single-news-page__date">
						<?= get_the_date('d F Y'); ?>
						<span><?= get_the_date('G:i'); ?></span>
					</time>

					<div class="share single-news-page__share">
						<div class="share__title">
							Поделиться:
						</div>
						<ul class="share__list">
							<li class="share__item">
								<a href="" target="_blank" rel="nofollow" class="share__link">
					...
					<a href="<?= site_url(); ?>/#products" class="single-news-page__products-banner">
						<picture>
			...
			<div class="single-news-page__content">
				<article class="single-news-page__article">

					<h1 class="single-news-page__heading">
						<?php the_title(); ?>
					</h1>
				...
				<nav class="single-news-page__articles-nav articles-nav">
					<ul class="articles-nav__list">
						...
						if ($next_post) : ?>
							<li class="articles-nav__item articles-nav__item--next">
								...
								<div class="articles-nav__news-item news-item">
									<?php get_template_part('template-parts/content', 'news-item', array('id' => $next_post->ID)); ?> </div>
							</li>
						<?php endif; ?>
					</ul>
				</nav>
