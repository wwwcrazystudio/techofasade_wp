						...
						<form class="modal-form__content" data-form>
							<div class="modal-form__input input--icon input">
								<div class="input__wrap">
									...
									<label for="name_modal" class="input__label input__label--hidden">
										Имя
									</label>
									<input class="input__control" id="name_modal" placeholder="Имя" name="name" required minlength="2">
								</div>
							</div>
							<div class="modal-form__input input--icon input">
								<div class="input__wrap">
									...
									<label for="tel_modal" class="input__label input__label--hidden">
										Телефон
									</label>
									<input type="tel" class="input__control" id="tel_modal" name="tel" required placeholder="+7 (***) ***-**-**" required minlength="18">
								</div>
							</div> 
...
<dialog class="modal" id="testimonial-modal">
	<div class="modal__content">
		<button class="modal__close">
			<svg width="85" height="85" viewBox="0 0 85 85" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M63.6328 21.2031L21.2064 63.6295" stroke="white" stroke-width="4" stroke-linecap="round" />
		...
		<div class="modal__body modal__body--testimonial">
			<div class="modal__testimonial-item testimonial-item" data-testimonial-content>
